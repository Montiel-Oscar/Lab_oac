...
\begin{center}
    ...
    {\LARGE \textbf{Reporte Practica 4}}\\[0.5cm]
    {\LARGE {Construción de Máquinas de estados Usando Memorias Direccionamiento Entrada - Estado}}\\[1cm]

    {\Large \textbf{Fecha de Entrega}}\\[0.2cm]
    {\Large 2 de Octubre del 2026} \\[1cm]
